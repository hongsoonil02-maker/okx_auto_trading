...
def main():
    ...
    configs = [
        ...
        # [추가 검증 8] 듀얼 게이트를 끄고 ADX 필터만 유지 → 추세 없는 구간의 포지션 과잉 축소
        ("8. [듀얼게이트 OFF] ADX>20 + 빅스윙, 듀얼 게이트 비활성", 10, -0.08, True, None, 2.5, 0.20, 0.30, False, 20.0),
        # [추가 검증 9] 듀얼 게이트 유지하지만 ADX 임계값 낮추고 EXPOSURE_SCALE=1.0
        ("9. [EXPOSURE 100%] 듀얼게이트 ON + ADX>15 + 빅스윙", 10, -0.08, True, None, 2.5, 0.20, 0.30, True, 15.0),
    ]
