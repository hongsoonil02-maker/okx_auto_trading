...
async def main():
    print("📡 Venture Stock Tournament 시작...")
    results = {}
    ...
    if results:
        from tournament_common import save_results_history, promote_strategy, load_promoted_config
