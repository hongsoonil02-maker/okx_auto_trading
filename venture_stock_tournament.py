...
VENTURE_STOCK_SYMBOLS = ['SPACEX/USDT:USDT', 'OPENAI/USDT:USDT', 'ANTHROPIC/USDT:USDT', 'RDDT/USDT:USDT', 'XSTOCKS/USDT:USDT']
TIMEFRAME = "15m"
LIMIT = 2000
...
async def main():
    ...
    print("📡 Fetching data for Venture US Stock Tokens on OKX...")
    for sym in VENTURE_STOCK_SYMBOLS:
    ...
    if not data_map:
        print(json.dumps({"error": "No data found for any venture stock symbols."}))
        return

    report = {}
    
    # 1. Current Venture Stock Base
    agent_name = "Current_Venture_Stock_Base"
    params = {"ema_period": 200, "tight_mult": 2.5, "loose_mult": 4.0, "vol_mult": 1.1, "min_hold": 3, "max_dca": 3, "tp_thr": 1.02, "scale_out": False}
