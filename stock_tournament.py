...
STOCK_SYMBOLS = ['TSLA/USDT:USDT', 'NVDA/USDT:USDT', 'AAPL/USDT:USDT', 'AMZN/USDT:USDT', 'MSFT/USDT:USDT', 'META/USDT:USDT', 'GOOG/USDT:USDT']
TIMEFRAME = "15m"
LIMIT = 2000
...
async def main():
    ...
    print("📡 Fetching data for US Stock Tokens on OKX...")
    ...
    if not data_map:
        print(json.dumps({"error": "No data found for any stock symbols. OKX might not support these tokens on swap."}))
        return

    report = {}
    
    # 1. Current Stock Base
    agent_name = "Current_Stock_Base"
    params = {"ema_period": 200, "tight_mult": 2.5, "loose_mult": 4.0, "vol_mult": 1.2, "min_hold": 3, "max_dca": 3, "tp_thr": 1.01, "scale_out": False}
