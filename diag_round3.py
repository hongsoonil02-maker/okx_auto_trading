...
async def main():
    ...
    configs = [
        ("C0_baseline", {}),
        ("C1_maj10x", {'lev_major': 10}),
        ("C2_maj5x", {'lev_major': 5}),
        ("C3_nosoft", {'no_soft': True}),
        ("C4_10x+nosf", {'lev_major': 10, 'no_soft': True}),
        ("C5_10x+ns+fastTrail", {'lev_major': 10, 'no_soft': True,
                                 'trail_arm': 0.10, 'trail_k': 2.0}),
    ]
